                                                ...
                                                <div className="flex items-center gap-8">
                                                    ...
                                                    {canEdit && (
                                                        <div className="flex items-center gap-1">
                                                            <button onClick={() => startEdit(exam)} className="p-2 text-neutral-800 hover:text-blue-500/50 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all"><Icons.Pencil className="w-4 h-4" /></button>
                                                            <button onClick={() => deleteExam(exam.id)} className="p-2 text-neutral-800 hover:text-red-500/50 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all"><Icons.Trash2 className="w-4 h-4" /></button>
                                                        </div>
                                                    )}
                                                </div>
                                            </motion.div>
